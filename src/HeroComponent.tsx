  ...
  return (
    <section className="min-h-screen bg-[#F9FAFB] text-stone-900 dark:bg-[#1E1E22] dark:text-zinc-100 transition-colors duration-500">
      <div className="mx-auto max-w-6xl px-6 py-5 ">
        <div className="flex mx-auto py-3 items-center justify-between">
          {/*Icons!!!*/}
...
border border-stone-300 dark:border-zinc-800 p-2"
        ...
        <div className="mt-15">
          <h1 className="text-3xl font-bold">What I Bring</h1>
        </div>
        ...
        >
          <div className="flex flex-col gap-3">
            <svg
              ...
              stroke-width="1.5"
              stroke="currentColor"
              className="size-9 text-[#3B82F6] dark:text-blue-300"
            >
              <path
                stroke-linecap="round"
                stroke-linejoin="round"
          ...
          <div className="flex flex-col gap-3">
            ...
            <p className="mt-3 text-gray-700 dark:text-gray-400 mt-2 text-sm">
              Designing distributed systems and database architectures.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-3">
            ...
            <p className="mt-3 text-gray-700 dark:text-gray-400 mt-2 text-sm">
              Working closely with cross-functional teams to deliver impactful
              solutions.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-3">
            ...
            <h2 className="text-lg font-semibold">Continous Improvement</h2>

            <p className="mt-3 text-gray-700 dark:text-gray-400 mt-2 text-sm">
              Passioante about learning, automation and delivering high-quality
              code.
            </p>
          </div>
        </div>
